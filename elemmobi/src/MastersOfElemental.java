...
//            fh = new FileHandler(login+".log", true);
        ...
        HtmlAnchor entranceForPlayers = currentPage.getAnchorByText("Вход для игроков");
...
//        }
        ...
        if (currentPage.getUrl().toString().equals("http://elem.mobi/")) {
            IsLogin = true;
        ...
        try {
            logger.info(new String("Login game  as ".getBytes(), "cp1251") + login);
